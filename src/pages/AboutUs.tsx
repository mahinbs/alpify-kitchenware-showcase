...
const AboutUs = () => {
  ...
  return <div className="min-h-screen overflow-hidden">
      ...
      <motion.section ref={heroRef} className="relative pt-24 pb-20 overflow-hidden" style={{
      background: `
      ...
      duration: 1
        ...
        <div className="absolute inset-0 overflow-hidden">
          {Array.from({
          length: 20
        }).map((_, i) => <motion.div key={i} ref={addParticleRef} className="absolute w-4 h-4 bg-white/20 rounded-full blur-sm" style={{
        ...
        {/* Morphing Shapes */}
        <motion.div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-vibrant-orange/30 to-electric-blue/30 rounded-full blur-xl" animate={{
        scale: [1, 1.5, 1],
        rotate: [0, 180, 360],
        ...
        <motion.div className="absolute bottom-20 right-20 w-40 h-40 bg-gradient-to-br from-emerald-green/30 to-vibrant-purple/30 rounded-full blur-xl" animate={{
        scale: [1.2, 0.8, 1.2],
        rotate: [360, 180, 0],
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center text-white z-10">
          <motion.h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-vibrant-orange to-electric-blue bg-clip-text text-transparent" initial={{
          opacity: 0,
          y: 50,
          scale: 0.9
        }} animate={{
          ...
          <motion.p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto leading-relaxed" initial={{
          opacity: 0,
          y: 30
        }} animate={{
          opacity: 1,
          ...
          {/* Animated Stats */}
          <motion.div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 max-w-3xl mx-auto" variants={containerVariants} initial="hidden" animate="visible">
            {[{
            number: "25+",
          ...
          }].map((stat, index) => <motion.div key={index} className="text-center p-4 bg-white/10 backdrop-blur-md rounded-lg border border-white/20" variants={itemVariants} whileHover={{
            scale: 1.05,
            rotate: 2
          }}>
      ...
      <section className="py-20 bg-gradient-subtle relative overflow-hidden">
        <motion.div className="absolute inset-0 bg-gradient-to-r from-emerald-green/5 to-electric-blue/5" animate={{
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <motion.div className="grid md:grid-cols-2 gap-12 items-center" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} viewport={{
          ...
          duration: 0.8
            ...
            <motion.div className="bg-card p-8 rounded-2xl shadow-elegant hover:shadow-glow transition-all duration-500 border border-steel-light/20" variants={cardVariants} initial="hidden" whileInView="visible" viewport={{
            once: true
          }} whileHover={{
            scale: 1.02,
            rotateY: 5,
      ...
      <section className="py-20 bg-background relative">
        <div className="max-w-6xl mx-auto px-6">
          ...
          duration: 0.8
            ...
            <motion.div className="bg-card p-8 rounded-2xl shadow-elegant hover:shadow-glow transition-all duration-500 border border-steel-light/20 order-2 md:order-1" variants={cardVariants} initial="hidden" whileInView="visible" viewport={{
            once: true
          }} whileHover={{
            scale: 1.02,
            rotateY: -5,
            ...
            <motion.div className="order-1 md:order-2" variants={itemVariants} initial="hidden" whileInView="visible" viewport={{
            once: true
          }}>
      ...
      <section className="py-20 bg-gradient-subtle relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          ...
          once: true
            ...
            color: "electric-blue"
          }].map((item, index) => <motion.div key={index} className="text-center p-8 bg-card rounded-2xl shadow-elegant hover:shadow-glow transition-all duration-500 border border-steel-light/20 group" variants={cardVariants} whileHover={{
            scale: 1.05,
            y: -10,
            rotateY: 5
          }}>
                <motion.div className="text-6xl mb-6 group-hover:scale-110 transition-transform duration-300" animate={{
              rotate: [0, 10, -10, 0]
            }} transition={{
              duration: 4,
              repeat: Infinity
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-vibrant-purple to-electric-blue text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <motion.div className="grid md:grid-cols-4 gap-8 text-center" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{
          once: true
        }}>
            {[{
            number: "25+",
            ...
            label: "Quality Assured",
            icon: "✨"
          }].map((stat, index) => <motion.div key={index} className="p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300" variants={itemVariants} whileHover={{
            scale: 1.05,
            y: -5
          }}>
                <div className="text-3xl mb-2">{stat.icon}</div>
                <motion.div className="text-4xl font-bold mb-2 text-vibrant-orange" initial={{
              scale: 0
            }} whileInView={{
              scale: 1
            }} viewport={{
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          duration: 0.8
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <motion.a href="tel:+919886317956" className="group bg-gradient-to-r from-primary to-vibrant-orange text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-glow flex items-center space-x-2" whileHover={{
              scale: 1.05,
              y: -2
            }} whileTap={{
              scale: 0.95
              ...
              <motion.a href="mailto:info@alpifyglobal.com" className="group bg-card text-primary border-2 border-primary px-8 py-4 rounded-xl font-semibold hover:bg-primary hover:text-white transition-all duration-300 flex items-center space-x-2" whileHover={{
              scale: 1.05,
              y: -2
            }} whileTap={{
              scale: 0.95
                ...
                <span>✉️</span>
                <span>jatin@alpifyglobal.com</span>
              </motion.a>
            </div>
          </motion.div>
        </div>
