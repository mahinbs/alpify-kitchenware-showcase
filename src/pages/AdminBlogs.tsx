        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-vibrant-orange">{stats.totalViews.toLocaleString()}</p>
                </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 space-y-4 md:space-y-0">
            ...
            <motion.button
              ...
              className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-primary to-vibrant-orange text-white rounded-lg font-semibold hover:shadow-glow transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <motion.button
                      ...
                      className="px-3 py-2 bg-destructive text-white rounded-lg hover:bg-destructive/90 transition-colors"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
          ...
          {filteredBlogs.length === 0 && (
            ...
            >
              ...
              {!searchTerm && categoryFilter === "all" && (
                <motion.button
                  onClick={handleAddBlog}
                  className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-primary to-vibrant-orange text-white rounded-lg font-semibold hover:shadow-glow transition-all duration-300 mx-auto"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <Plus className="w-5 h-5" />
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    className="w-full mt-2 px-4 py-2 border border-border rounded-lg bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    required
                  >
              ...
              <div>
                ...
                <Input
                  ...
                  className="mt-2"
                  placeholder="stainless steel, kitchenware, cooking"
                />
              </div>
